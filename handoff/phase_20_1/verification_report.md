...
All targeted Phase 20.1 checks passed on 2026-04-25.
...
- Phase 20 gap regression tests: 9 passed, 0 failed.
...
- Locality signal normalization and identity.
- Locality filtering and all-locality rollups.
- Nullable locality handling.
- Locality sorting, grouping, determinism, and no-mutation guarantees.
