...
## Notes
- Saved lists store only user input.
- Saved-list optimization does not cache optimizer output.
- Existing resolver, planner, price, optimizer, analytics, and health logic remain unchanged.
