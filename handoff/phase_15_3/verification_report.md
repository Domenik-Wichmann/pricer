...
## Notes
- Phase 15.3 adds a read-only shopping-list resolution layer that ranks canonical product candidates through the product-service surface.
- The resolver keeps `canonical_with_enrichment` as the default layer and does not mutate canonical truth, applied-view state, or enrichment cache.
