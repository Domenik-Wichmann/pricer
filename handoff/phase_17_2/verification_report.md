...
## Notes
- Watchlist tracker records do not store price snapshots.
- Price tracker view reads current prices through Phase 16.0 price lookup.
- Notification sending is intentionally not implemented.
